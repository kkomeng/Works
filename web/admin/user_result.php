          ...
          <div class="modal-body">
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-sm">
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="退勤" id="modal_end_time" name="modal_end_time"
                ...
                <div class="col-sm">
                  <input type="text" class="form-control" placeholder="休憩" id="modal_break_time" name="modal_break_time"
                    value="<?= format_time($modal_break_time) ?>">
                </div>
              </div>
              <div class="form-group pt-3">
                <textarea class="form-control" id="modal_comment" name="modal_comment" rows="5"
